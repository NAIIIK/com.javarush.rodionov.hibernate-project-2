...
| Method                                                                                  | Description |
|-----------------------------------------------------------------------------------------|---|
| `releaseFilm(languageId, actorIdList, categoryIdList, storeIdList, copiesPerStore)`     | A new film is released — created with actors/categories and added to each store's inventory |
